...
import img2 from 'img/big-img02.jpg';
import img3 from 'img/big-img03.jpg';
import img4 from 'img/big-img04.jpg';
...
#sponsored</a></h2>
								...
								<div className="festival-ftr d-flex">
									<div className="festival-ftr-l"><a href=""><i><img src={pinImg} alt="" /></i><strong>823M</strong></a></div>
									<div className="festival-ftr-r dropdown">
                                        <PlusAction/>
									</div>
								</div>
						...
						<li>
							<div className="fan-festival-box">
								...
								<div className="festival-img"><img src={img4} alt="" /></div>
								<div className="festival-body">
									<h2>Make up by morning. boyfriends happy, what a life I lead! <a href="">@thegrocer #morning #earlyriser #excited
#sponsored</a></h2>
								</div>
								<div className="festival-ftr d-flex">
									<div className="festival-ftr-l"><a href=""><i><img src={twitterImg} alt="" /></i><strong>823M</strong></a></div>
									<div className="festival-ftr-r dropdown">
                                        <PlusAction/>
									</div>
								</div>
